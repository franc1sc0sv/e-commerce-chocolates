...
export default function Header() {
    const NavLinkStyles = "text-primary font-bold opacity-50 hover:opacity-100 border-transparent border-b-[2px] hover:border-primary duration-[500ms] ease-in-out"
    ...
    return (
        <div className="w-full flex justify-between px-10 py-4 items-center">
            ...
            <div className="flex gap-4 w-full justify-end">
                <NavLink to={"/iniciarSesion"} className=" flex items-center text-lg w-fit bg-primary text-white font-Outfit font-medium p-2 rounded hover:bg-white hover:text-primary border border-primary duration-[500ms] ease-in-out" >Inicio de Sesion</NavLink>
                <NavLink to={"/carrito"} className=" items-center flex gap-3 border border-primary w-fit px-4 py-[10px] rounded font-Outfit text-primary font-medium hover:bg-primary hover:text-white duration-[500ms] ease-in-out relative group">
